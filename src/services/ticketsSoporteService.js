...
// Obtener informacion de tickets para el dashboard
export const getTicketsDashboard = async () => {
  try {
...
export const getReporteTickets = async (params) => {
  try {
    const response = await axios.get(`${API_BASE_URL}tickets-reporte${params}`);
    return response;
  } catch (error) {
